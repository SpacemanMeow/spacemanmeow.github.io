...
categories: [教程]
tags: [记账, 记账应用, 预算管理, 财务管理, 指纹锁, 可爱记账APP]
lang: zh-CN
...
喵窝记账是一款专为个人财务管理打造的可爱卡通风格记账应用。应用以猫咪为主题，界面设计萌趣可爱，同时功能强大且实用，帮助您轻松掌控个人财务状况，支持 Android 平台 [Google Play 下载](https://play.google.com/store/apps/details?id=com.glgjing.money.manager.bookkeeping.meow&hl=en) 和 iOS 平台 [App Store 下载](https://apps.apple.com/us/app/meow-money-manager/id1528852284)。

**🐱 超萌界面设计**
- 猫咪主题的可爱卡通界面，让记账变得有趣
- 500+ 个精心设计的卡通图标，每个图标都萌趣十足
- 支持深色模式、浅色模式和跟随系统主题，满足不同场景使用需求

**💰 全面的记账功能**
- 支持支出、收入、转账三种记账类型
- 丰富的分类图标，涵盖餐饮、购物、交通、娱乐、医疗等各类生活场景
- 支持添加备注，记录消费详情
- 快速记账，一键完成

**📊 智能预算管理**
- 支持多个预算同时追踪
- 灵活的预算周期设置：每日、每周、每月、每年或自定义周期
- 分类预算功能，为不同消费类别设置独立预算
- 实时显示预算使用情况、剩余金额和日均预算

**📈 强大的统计分析**
- 饼图展示：直观显示各类别收支占比
- 柱状图展示：按日或按月展示收支趋势
- 日历视图：通过颜色深浅快速识别每日收支情况
- 支持按日、周、月、年及自定义时间范围统计

**📒 多账本管理**
- 支持创建多个账本，分类管理不同类型的收支
- 每个账本独立统计，清晰明了
- 快速切换账本，方便记录不同场景的财务

**🔄 周期自动记账**
- 自动记录定期收支，如工资、房租、水电费等
- 支持每日、每周、每月、每年多种循环周期
- 支持同时选择多个日期，灵活设置记账时间

**💵 多货币支持**
- 支持50+种货币符号，包括人民币、美元、欧元、英镑等
- 满足不同国家和地区用户的需求
...
**☁️ 数据备份与恢复**
- 支持 Google Drive 备份、iCloud 备份（iOS 版本）、WebDAV 云盘备份
- 自动备份功能，防止数据丢失
- 支持手动备份和恢复
- 数据导出为 CSV 格式，方便在 Excel 中查看和编辑

**💳 资产管理**
- 支持管理多种资产类型：现金、银行卡、信用卡、股票、基金等
- 资产趋势统计，掌握资产变化
- 资产间转账功能，方便资金调配
...
主界面包含以下几个主要部分：
- 记账按钮：位于底部右侧，用于快速添加记账记录
- 底部导航栏：包含记账、统计、资产、设置四个选项
- 顶部横幅：显示当前账本和资产概览
...
喵窝记账的记账功能非常直观，支持支出、收入和转账三种类型的记录。

### 添加支出或收入记录

1. 点击首页底部的记账按钮
2. 在弹出的记账界面中，切换到支出或收入标签
3. 选择合适的分类图标（如餐饮、购物、交通等）
4. 输入金额
5. 选择支付方式（资产）
6. 选择所属账本
7. 添加备注（可选）
...
喵窝记账支持多种类型的预算管理，包括每日、每周、每月、每年和自定义周期的预算。

### 添加预算

1. 在主界面点击预算横幅或从设置中进入预算管理
2. 点击"添加预算"按钮
3. 选择预算类型（每日、每周、每月、每年或自定义）
4. 点击"添加分类预算"，选择要设置预算的分类
5. 输入总预算金额或者输入每个分类的预算金额
6. 输入预算名称
7. 点击确认完成预算创建
...
喵窝记账提供多种统计分析功能，帮助您了解自己的财务状况。

### 统计类型

1. 在主界面点击底部统计导航栏进入统计页面
2. 选择统计时间范围：日、周、月、年或自定义
3. 查看不同类型的统计图表

- **饼图统计**: 饼图展示了不同分类的支出和收入占比，帮助您了解钱花在了哪里。
- **柱状图统计**：柱状图展示了每日或每月的收支情况，帮助您了解收支趋势。
- **日历视图**：日历视图展示了每日的收支情况，通过颜色深浅表示金额大小。
...
喵窝记账支持管理多种类型的资产，如现金、银行卡、信用卡等。

### 添加资产

1. 在主界面点击底部资产导航栏进入资产页面
2. 点击"添加资产"按钮
3. 选择资产类型
4. 输入资产名称
5. 输入初始金额
...
喵窝记账支持创建多个账本，用于管理不同类型的收支。

### 添加账本

1. 在主界面点击账本横幅或从设置中进入账本管理
2. 点击"添加账本"按钮
3. 输入账本名称
4. 选择账本图标
5. 点击确认完成账本创建
...
周期记账功能可以帮助您自动记录定期的收支，如工资、房租、水电费等。
...
喵窝记账是一款功能强大、界面可爱的个人财务管理应用，通过本教程，您应该已经掌握了它的主要功能和使用方法。希望它能帮助您更好地管理个人财务，让记账变得更加轻松愉快！

如果您在使用过程中遇到任何问题，欢迎随时联系向我反馈，我的邮箱: glgjingmarvel@gmail.com